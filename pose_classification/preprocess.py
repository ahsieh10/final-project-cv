    ...
    def get_data(self, path, is_vgg, shuffle, augment):
        ...
        if augment:
            ...
            data_gen = tf.keras.preprocessing.image.ImageDataGenerator(
                preprocessing_function=self.preprocess_fn, rotation_range=10, width_shift_range=0.1, height_shift_range=0.1, zoom_range=0.1,horizontal_flip=True)
                #preprocessing_function=self.preprocess_fn, horizontal_flip=True)
